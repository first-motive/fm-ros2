...
Paths are the in-container locations under ``/ws/src/external`` (gitignored on the
...
_MJCF = {
    ...
    "openarm": "/ws/src/external/openarm_mujoco/v2/openarm_bimanual.xml",
    # Vendored official SO101 model; joint names match the system exactly.
    "so101": "/ws/src/external/so_arm/Simulation/SO101/so101_new_calib.xml",
    ...
    "g1_d": "/ws/src/external/unitree_mujoco/unitree_robots/g1/g1_29dof.xml",
}
