...
Guidance for Claude Code and Codex working in the `fm-policy` repo. See the
[README](README.md) for the package overview.

## Purpose

First Motive policy layer: training and serving the learned policies. Part of First Motive's ROS2 (Humble) stack — one of seven package
...
```bash
vcs import < fm-policy.repos     # siblings + externals
