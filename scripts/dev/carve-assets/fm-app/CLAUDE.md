...
Guidance for Claude Code and Codex working in the `fm-app` repo. See the
[README](README.md) for the package overview.

## Purpose

First Motive application layer: the bringup launch orchestration and the operator TUI. Part of First Motive's ROS2 (Humble) stack — one of seven package
...
```bash
vcs import < fm-app.repos     # siblings + externals
